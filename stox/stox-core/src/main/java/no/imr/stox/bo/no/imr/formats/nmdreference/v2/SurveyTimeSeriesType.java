...
/**
 * <p>Java class for SurveyTimeSeriesType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SurveyTimeSeriesType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="id" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="code" type="{http://www.imr.no/formats/nmdreference/v2.0}StringWithAnyAttributes"/&gt;
 *         &lt;element name="shortname" type="{http://www.imr.no/formats/nmdreference/v2.0}StringWithAnyAttributes"/&gt;
 ...
 *         &lt;element name="cruiseSeries"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="cruiseSeries" type="{http://www.imr.no/formats/nmdreference/v2.0}SurveyTimeSeriesCruiseSeriesType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "SurveyTimeSeriesType", propOrder = {
    "id",
    "code",
    "shortname",
    "name",
...
public class SurveyTimeSeriesType {

    protected String id;
    @XmlElement(required = true)
    protected StringWithAnyAttributes code;
    @XmlElement(required = true)
    protected StringWithAnyAttributes shortname;
    @XmlElement(required = true)
    protected StringWithAnyAttributes name;
    protected StringWithAnyAttributes description;
    @XmlElement(required = true)
    protected SurveyTimeSeriesType.CruiseSeries cruiseSeries;
     ...
     *     
     */
    public StringWithAnyAttributes getShortname() {
        return shortname;
    }
     ...
     *     
     */
    public void setShortname(StringWithAnyAttributes value) {
     ...
     * @return
     *     possible object is
     *     {@link SurveyTimeSeriesType.CruiseSeries }
     *     
     */
    public SurveyTimeSeriesType.CruiseSeries getCruiseSeries() {
        return cruiseSeries;
    }
     ...
     *     
     */
    public void setCruiseSeries(SurveyTimeSeriesType.CruiseSeries value) {
    ...
    public static class CruiseSeries {

        protected List<SurveyTimeSeriesCruiseSeriesType> cruiseSeries;
         ...
         * This is why there is not a <CODE>set</CODE> method for the cruiseSeries property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getCruiseSeries().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link SurveyTimeSeriesCruiseSeriesType }
         * 
         * 
         */
        public List<SurveyTimeSeriesCruiseSeriesType> getCruiseSeries() {
            if (cruiseSeries == null) {
                cruiseSeries = new ArrayList<SurveyTimeSeriesCruiseSeriesType>();
            }
            return this.cruiseSeries;
        }

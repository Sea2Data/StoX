        ...
        switch (level) {
            ...
            case 4:
                ImrIO.write(wr, ExportUtil.carrageReturnLineFeed(ExportUtil.tabbed(
                        ...
                        "individualweight",
                        ExportUtil.getObj("IndividualWeightG", ml.isIndividualWeightGAdded(), notIncluded),
                        ...
                        for (CatchSampleBO cs : fs.getCatchSampleBOs()) {
                            ...
                            for (IndividualBO ii : cs.getIndividualBOs()) {
                                ...
                                ImrIO.write(wr, ExportUtil.carrageReturnLineFeed(ExportUtil.tabbed(
                                        ...
                                        ExportUtil.getObj(ii.getIndividualWeightG(), ml.isIndividualWeightGAdded(), notIncluded),
